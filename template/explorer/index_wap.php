...
<head>
	...
	<title>我的云盘-<?php echo $this->roominfo['crname'];?></title>
	<script type="text/javascript" src="http://static.ebanhui.com/js/lefttool/jQuery.js"></script>
	<script type="text/javascript" src="http://static.ebanhui.com/js/lefttool/lefttool.js"></script>
	<link rel="stylesheet" type="text/css" href="http://static.ebanhui.com/js/lefttool/css/lefttool.css" />
...
<body>
	...
	<div class="frame-main"><!--页面内容整体侧滑最外层div-->
		<div class="panel-mask"></div><!--阴影层-->
	<div class="init_loading"><div><img src="<?php echo STATIC_PATH;?>images/common/loading_simple.gif"/></div></div>


		<div class="frame-header">
			<div class="tool left_tools tool left_tool"><i class="font-icon icon-list"></i></div>
