...
/********************以下配置 eker-hfs添加 整合ebh********************************/
define('SYS_PATH',		LIB_DIR .'core/');
define('MODEL_PATH',     BASIC_PATH .'model/');
define('LIB_PATH', BASIC_PATH . 'libclass/');
define('S_ROOT', BASIC_PATH);
define('CONFIG_PATH', BASIC_PATH . 'config/');
defined('EBH_BEGIN_TIME') or define('EBH_BEGIN_TIME', microtime(true));//定义项目当前时间
defined('SYSTIME') or define('SYSTIME', time());//定义项目当前时间
...
/**重写 ebh eker-hfs*/
include(CORER_DIR.'Ebh.class.php');
include(CORER_DIR.'EbhController.class.php');
